...
from versal.evolution.registry import Registry, _bind_prefixed, build_evolver
...
from versal.utils.resources import ResourceEstimate, ResourcePolicy
...
class HierarchicalLoop:
    ...
    def fresh_state(self, rng: random.Random) -> HierarchicalState:
        ...
        if self.library is not None and self.seed_fraction > 0.0:
            from versal.library import graft
...
def build_hierarchical(config: dict[str, Any]) -> HierarchicalLoop:
    from versal.evolution import composition, selection
