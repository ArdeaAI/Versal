...
Everything goes through `versal.rendering`, so nested networks expand into callout boxes across the
...
from versal.rendering import DEFAULT_NODE_BUDGET, render_entry, render_library_gallery
