...
from versal.motifs import MAX_MOTIF_SIZE, CensusReport, MotifRecord, empty_state_explanation, motif_census, report_to_dict
...
def main() -> None:
    ...
    if args.discover or args.counterfactual:
        ...
        from versal.motif_discovery import discover_motifs, write_discoveries
