...
A thin orchestration over the existing torch path in `versal/dataset/icarus.py`. The task is
...
if TYPE_CHECKING:
    from versal.substrate import RefineGraphNet

from versal.dataset.icarus import (
    EncodedTask,
    FieldDescriptor,
    Level0Encoder,
    Task,
