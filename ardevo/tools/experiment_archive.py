...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description="External ArdEVO experiment archive maintenance.")
    parser.add_argument("--uri", default=None, help="file:///... or s3://bucket/prefix (otherwise read --uri-env).")
    parser.add_argument("--uri-env", default="ARDEVO_ARCHIVE_URI", help="Environment variable used when --uri is absent.")
