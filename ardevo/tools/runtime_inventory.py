"""Generate or verify ArdEVO's deterministic canonical-runtime inventory."""
...
REGISTRY_MODULES = (
    "ardevo.decompose",
    "ardevo.evolution.composition",
    "ardevo.evolution.crossover",
    "ardevo.evolution.evaluate",
    "ardevo.evolution.fitness",
    "ardevo.evolution.init",
    "ardevo.evolution.loop",
    "ardevo.evolution.mutation",
    "ardevo.evolution.schedule",
    "ardevo.evolution.selection",
    "ardevo.evolution.speciation",
    "ardevo.evolution.train",
    "ardevo.library",
    "ardevo.strategy",
)
...
def _registry_surface() -> dict[str, list[str]]:
    ...
    for module_name in REGISTRY_MODULES:
        ...
        for value in vars(module).values():
            ...
            registries[value.kind] = sorted(name for name, item in value._items.items() if getattr(item, "__module__", "").startswith("ardevo."))
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate or verify runtime_inventory.json against the canonical ArdEVO runtime surface.")
