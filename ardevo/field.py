...
from ardevo.dataset.icarus import Axis, EncodedTask, Field, FieldDescriptor, Level0Encoder, Task, ValueType, as_logits, model_output_features
from ardevo.evaluation import split_metrics_from_raw
from ardevo.evolution.genome import Genome, genome_from_dict
...
class FieldAdapter:
    ...
    def decode(self, genome: Genome) -> SubstrateModule:
        from ardevo.library import macro_resolver
